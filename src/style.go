...
func DefaultStyles() *Styles {
	...
	s.SettingsTitleColor = lipgloss.Color("#9B8B9F")         // Muted purple-gray
	s.SettingsSelectedTitleColor = lipgloss.Color("#C5B0C9") // Soft purple-gray
	...
	s.SettingsEnabledColor = lipgloss.Color("#A8DDA8")       // Soft pastel green
	s.SettingsDisabledColor = lipgloss.Color("#E8999D")      // Soft pastel red
